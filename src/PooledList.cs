...
/// Usage:
/// <code>
/// using var list = new PooledList&lt;Foo&gt;(16);
/// list.Add(...);
...
/// missed pool reuse. <c>default(PooledList&lt;T&gt;)</c> is valid: empty, lazy-allocates
/// on first Add, Dispose is a no-op when never used.
/// </summary>
internal ref struct PooledList<T>
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => _array == null ? Span<T>.Empty : _array.AsSpan(0, _count);
    }
